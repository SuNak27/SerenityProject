    ...
    declare namespace Db {
        ...
        namespace Perpustakaan {
            ...
            namespace Peminjamanbuku {
                ...
                export const IdBukuDeskripsiBuku: string;
                export const IdBukuGambarBuku: string;
                export const IdBukuJudulBuku: string;
                export const IdBukuKodeBuku: string;
                export const IdBukuPenerbit: string;
                export const IdBukuPengarang: string;
